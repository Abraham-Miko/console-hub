<div id="create-modal" tabindex="-1" aria-hidden="true"
    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 justify-center z-50 items-center w-full inset-0">

    <div class="relative p-4 w-full max-w-2xl max-h-full">

        <div class="relative bg-gray-800 border border-gray-700 rounded-lg shadow-2xl p-4 md:p-6 z-[10001] mt-20">
            ...
            <form action="{{ route('pemesanan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid gap-4 grid-cols-2 py-4 md:py-6 overflow-y-auto max-h-[70vh] p-4">

                    <div class="col-span-2 sm:col-span-1">
                        <label for="jenis_peralatan_id" class="block mb-2.5 text-sm font-medium text-gray-300">Pilih Jenis</label>
                        <select id="jenis_peralatan_id" required
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="unit_peralatan_id" class="block mb-2.5 text-sm font-medium text-gray-300">Pilih Unit (Nomor Seri)</label>
                        <select id="unit_peralatan_id" name="id_unit_peralatan" required disabled
                                class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full px-3 py-2.5 placeholder:text-gray-400">
