    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function processVerificationToken(token) {
                ...
                modalContainer.innerHTML = `<div class="p-4">Memuat detail untuk token: ${token}...</div>`;

                // Panggil API yang sama dengan scanner
                ...
                <div id="verifikasi-modal" tabindex="-1" class="fixed inset-0 z-[10001] bg-black/50 flex justify-center items-center">
                    <div class="relative w-full max-w-lg">
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-2xl">
                            ...
                            <button data-modal-hide="verifikasi-modal" type="button" onclick="window.location.reload()" class="mt-3 text-gray-500">Batal/Tutup</button>
                        </div>
                    </div>
                </div>
            `;
                    ...
                    <div class="relative w-full max-w-lg">
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-2xl">
                            ...
                            <div class="mt-4 space-y-2 dark:text-white">
                                ...
                                <p><strong>KTP/SIM:</p> <img src="${storageBasePath}/${pemesananData.foto_ktp_sim}" alt="Foto Dokumen Jaminan" class="rounded-lg mt-2 w-full h-48 object-cover border border-gray-600"/>
