                ...
                >
                    ...
                    <a
                        ...
                        @if ($jenis->stok_tersedia > 0)
                            bg-[#ffa602] text-gray-900 hover:text-white shadow-md
                        @else
                            bg-gray-400 text-gray-600 hover:text-gray-600 cursor-not-allowed
                        @endif
                        "
                        @if ($jenis->stok_tersedia <= 0) disabled @endif
                    >
