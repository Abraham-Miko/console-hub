        ...
        <div class="container mx-auto px-6 mt-16">
            <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 justify-center">
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-gray-600">
                            Segala alat gaming yang kami sewakan memiliki harga yang bersahabat
                            untuk semua kalangan, sehingga Anda dapat menikmati pengalaman
                            bermain tanpa khawatir tentang biaya.
                        </p>
                    </div>
                </div>

                {{-- 2. Kemudahan penyewaan --}}
                <div class="flex items-start space-x-4">
                    <div class="p-3 bg-indigo-600 rounded-lg text-white">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">Kemudahan penyewaan</h3>
                        <p class="mt-2 text-gray-600">
                            Kamu tidak perlu repot-repot datang ke tempat kami.
                            Cukup lakukan penyewaan secara online melalui website kami
                            dan alatnya akan diantar langsung ke lokasi kamu.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">Kemudahan pembayaran</h3>
                        <p class="mt-2 text-gray-600">
                            Enggak punya cash? Tenang! Kami menerima berbagai metode pembayaran digital
                            yang memudahkan kamu untuk menyelesaikan transaksi tanpa ribet.
                        </p>
                    </div>
                </div>

                {{-- 4. Banyak pilihan alat gaming --}}
                <div class="flex items-start space-x-4">
                    <div class="p-3 bg-indigo-600 rounded-lg text-white">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">Banyak pilihan alat gaming</h3>
                        <p class="mt-2 text-gray-600">
                            Kami menyediakan berbagai jenis alat gaming mulai dari konsol,
                            aksesori, hingga game terbaru yang siap untuk disewa sesuai
