                            ...
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <div class="w-full bg-gray-700 rounded-full h-2">
                                        <div class="bg-blue-400 h-2 rounded-full" style="width: {{ ($pemesananDirental ?? 0) / ($totalPeralatan ?? 1) * 100 }}%"></div>
                                    </div>
                                </div>
                        ...
                        <div class="bg-gray-800 dark:bg-[#1f2937] shadow-xl rounded-lg overflow-hidden p-4 border border-gray-700 hover:shadow-2xl transition duration-200 h-36 flex flex-col justify-between">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-3xl font-extrabold text-white">{{ $stats['totalPeralatanDipesan'] ?? 'N/A' }}</p>
                                </div>
